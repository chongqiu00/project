...
int main(int argc,char *argv[],char *envp[])
{
  ...
  {
    printf("\n本程序用于生成全国气象站点观测的分钟数据。\n");
    printf("/htidc/shqx/bin/crtsurfdata 站点参数 数据文件存放的目录 日志文件名\n");
    printf("例如：/htidc/shqx/bin/crtsurfdata /htidc/shqx/ini/stcode.ini /data/shqx/ftp/surfdata /log/shqx/crtsurfdata.log\n");
    return -1;
  }
